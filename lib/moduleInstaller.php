...
class moduleInstaller extends db {
     ...
     */
    /*
    public function downgrade ($specific = null){
        // checks if module exists in registry
        if (!$this->isInstalled()){
            $this->error = 'Module ' . $this->installInfo['NAME'];
            $this->error .= ' does not exists in module registry - we can not downgrade!';
            return false;
        }
        ...
        if (!isset($specific)){
            ...
            $this->error = "You need to set a spcific version when downgrading. ";
            $this->error.= "Possible version are $possible_versions";
            return false;
        }
        ...
        if ( isset($version) ){
            //self::$dbh->commit();
            $this->confirm = "Module: " . $this->installInfo['NAME'] . " ";
            $this->confirm.= "Version: " . $version . " downgraded. ";
            $this->confirm.= "Downgraded from $row[module_version]";
            return true;
        } else {
            $this->confirm = "Nothing to downgrade. Module version is $row[module_version]";
            return true;
        }
    }*/
}

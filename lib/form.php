...
/**
 * Class contains contains class for creating forms
 * It is taken from the PEAR library, and redefined to the coscms purpose.
...
class HTML_Form
{
     ...
     * @since Property available since Release 1.3.0
     */
    var $_escape_default_from_input = false;
    ...
    function addCaptcha($name, $title, $default = null,
                     $size = HTML_FORM_TEXT_SIZE, $maxlength = 0,
                     $attr = '', $thattr = HTML_FORM_TH_ATTR,
                     $tdattr = HTML_FORM_TD_ATTR)
    {
    ...
    function addDatepicker($name, $title, $default = null,
                     $size = HTML_FORM_TEXT_SIZE, $maxlength = 0,
                     $attr = '', $thattr = HTML_FORM_TH_ATTR,
                     $tdattr = HTML_FORM_TD_ATTR)
    {
        $this->fields[] = array('datepicker', $name, $title, $default, $size,
                                $maxlength, $attr, $thattr, $tdattr);
    }
    ...
    function displayCaptcha($name, $default = null, $size = HTML_FORM_TEXT_SIZE,
                         $maxlength = 0, $attr = '')
    {
        print HTML_Form::returnCaptcha($name, $default, $size, $maxlength, $attr);
    }
    
    function displayDatepicker($name, $default = null, $size = HTML_FORM_TEXT_SIZE,
                         $maxlength = 0, $attr = '')
    {
        print HTML_Form::returnDatepicker($name, $default, $size, $maxlength, $attr);
    }
    ...
    function displayDatepickerRow($name, $title, $default = null,
                            $size = HTML_FORM_TEXT_SIZE, $maxlength = 0,
                            $attr = '', $thattr = HTML_FORM_TH_ATTR,
                            $tdattr = HTML_FORM_TD_ATTR)
    {
        print HTML_Form::returnDatepickerRow($name, $title, $default, $size,
                                       $maxlength, $attr, $thattr, $tdattr);
    }
    ...
    function returnCaptcha($name, $default = null, $size = HTML_FORM_TEXT_SIZE,
                        $maxlength = 0, $attr = '')
    {
        $str  = '<input type="text" name="' . $name . '" ';
        $str .= 'size="' . $size . '" value="' . $default . '" ';
     ...
     *      HTML_Form::returnTextRow(), HTML_Form::addText()
     */
    function returnDatepicker($name, $default = null, $size = HTML_FORM_TEXT_SIZE,
                        $maxlength = 0, $attr = '')
    {
        $str  = '<input type="text" name="' . $name . '" ';
        $str .= 'size="' . $size . '" value="' . $default . '" ';
                           ...
                           $tdattr = HTML_FORM_TD_ATTR)
    {
        ...
        //$str .= '  <td ' . $tdattr . ">\n   ";
        $str  = '';
        $str .= get_form_element_start($name, $title);
        $str .= HTML_Form::returnText($name, $default, $size, $maxlength,
                                      $attr);
        //$str .= "  </td>\n";
        //$str .= " </tr>\n";
        $str .= get_form_element_end();
        return $str;
    }

    function returnCaptchaRow($name, $title, $default = null,
                           $size = HTML_FORM_TEXT_SIZE, $maxlength = 0,
                           $attr = '', $thattr = HTML_FORM_TH_ATTR,
                           $tdattr = HTML_FORM_TD_ATTR)
    {
    ...
    function returnDatepickerRow($name, $title, $default = null,
                           $size = HTML_FORM_TEXT_SIZE, $maxlength = 0,
                           $attr = '', $thattr = HTML_FORM_TH_ATTR,
                           $tdattr = HTML_FORM_TD_ATTR)
    {
        ...
        $str  = '';
        $str .= get_form_element_start($name, $title);
        $str .= HTML_Form::returnDatepicker($name, $default, $size, $maxlength,
                                      $attr);
        //$str .= "  </td>\n";
        //$str .= " </tr>\n";
        $str .= get_form_element_end();
                             ...
                             $tdattr = HTML_FORM_TD_ATTR)
    {
        ...
        //$str .= '  <td ' . $tdattr . ">\n   ";
        $str = '';
        $str .= get_form_element_start($name);
                            ...
                            $tdattr = HTML_FORM_TD_ATTR)
    {
        ...
        //$str .= '  <td ' . $tdattr . ">\n   ";
        $str  = '';
        $str .= get_form_element_start('&nbsp;', $title);
                            ...
                            $tdattr = HTML_FORM_TD_ATTR)
    {
        ...
        $str  = '';
        $str .= get_form_element_start($name, $title);
        $str .= HTML_Form::returnRadio($name, $value, $default, $attr);
        $str .= get_form_element_end();
        return $str;
        //       "  </td>\n" .
        //       " </tr>\n";
                            ...
                            $tdattr = HTML_FORM_TD_ATTR)
    {
        ...
        $str  = '';
        $str .= get_form_element_start($name, $title);
        $str .= HTML_Form::returnImage($name, $src, $attr);
        $str .= get_form_element_end();
        //       "  </td>\n" .
        //       " </tr>\n";

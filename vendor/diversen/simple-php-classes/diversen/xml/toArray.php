...
class toArray {
     ...
     * @return array $ary The parsed XML in an array form. Use print_r() to see the resulting array structure. 
     * Examples: $array =  xml2array(file_get_contents('feed.xml')); 
     *           $array =  xml2array(file_get_contents('feed.xml', 1, 'attribute')); 
     */
    public static function get($contents, $get_attributes = 1, $priority = 'tag') {
        return self::xml2array($contents, $get_attributes, $priority);
    }

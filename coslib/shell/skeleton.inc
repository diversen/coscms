 ...
 */
function create_module_skeleton_v1($args){
...
self::setOption('create_module_skeleton_v1', array(
    'long_name'   => '--v1-create-module',
    'description' => 'specify v1 module to create',
    'action'      => 'StoreTrue'
));
